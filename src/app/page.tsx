    ...
    <div className="space-y-24 pb-32">
      ...
      <section className="max-w-7xl mx-auto px-6 md:px-8 pt-24 md:pt-32 text-center relative">
        <div className="space-y-6">
          ...
          <div className="mt-12 inline-flex items-center gap-4 bg-slate-900 text-slate-300 px-6 py-3 rounded-2xl font-mono text-sm border border-slate-800 shadow-2xl">
      ...
      <section className="max-w-7xl mx-auto px-6 md:px-8">
        <div className="glass-panel rounded-4xl p-8 md:p-12 flex flex-col md:flex-row justify-between items-center gap-8 md:gap-12">
          <div className="flex gap-8 md:gap-12">
            ...
            <div className="flex flex-col">
              <span className="text-3xl md:text-4xl font-bold font-headline">130+</span>
      ...
      <section className="max-w-7xl mx-auto px-6 md:px-8">
        ...
        <div className="grid md:grid-cols-3 gap-6">
          ...
          <div className="glass-panel p-8 rounded-4xl">
            ...
            <p className="text-on-surface-variant">Native support for Model Context Protocol connectors and 18+ pre-built tool integrations.</p>
          </div>
        </div>
          ...
          <div className="relative z-10 grid md:grid-cols-2 gap-8 md:gap-12 items-center">
            <div className="space-y-6">
              ...
              <div className="flex gap-8">
                ...
                <div><span className="block text-2xl font-bold">130+</span><span className="text-xs text-slate-400">Commits</span></div>
